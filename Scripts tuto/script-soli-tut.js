...
document.getElementById('RTIbutton').addEventListener('click' , function() {
    window.location.href = 'registroTI.php';
});

document.getElementById('PDF1button').addEventListener('click' , function() {
    window.location.href= 'remedial.php';
});

document.getElementById('PDF2button').addEventListener('click' , function() {
    window.location.href= 'asesoria.php';
});

document.getElementById('PDF3button').addEventListener('click' , function() {
    window.location.href= 'baja.php';
});

document.getElementById('TGRbutton').addEventListener('click' , function() {
    window.location.href= 'tutoria-GR.php';
});
...
document.getElementById('planeacionbutton').addEventListener('click' , function() {
    window.location.href= 'planeacion.php';
});