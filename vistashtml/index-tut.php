...
<body>
    ...
    <script src="../Scripts tuto/script-tut.js"></script> <!-- Agrega el archivo JavaScript -->
...
<!-- Los Siguientes id se colocan en los button para redirigir a la pagina correspondiente -->
