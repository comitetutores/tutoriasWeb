...
<body>
    ...
    <div class="outer-white-rectangle">
        <div class="white-rectangle">
            <h3>Bienvenido al Calendario</h3>
        </div>
      ...
      <div class="sidebar" id="sidebar">
        ...
        <!-- <button id="calbutton" class="sidebar-btn">
            <img src="../imagenes/iconos/calendario.png" alt="Icono 5" class="sidebar-icon">
            Calendario
            <div class="line"></div>
        </button> -->
        <button id="ayututbutton" class="sidebar-btn">
    ...
    <script src="../Scripts tuto/script-cal-tut.js"></script> <!-- Agrega el archivo JavaScript -->
